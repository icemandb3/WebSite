...
$(document).ready(function() {
	...
	*/
	...
	$('#googlecart-add').click(function(){
		//var carItCtb4 = googlecart.getItems();
		//if(carItCtb4.length > 0){
		//	alert("The cart has " + carItCtb4.length + " items.");
		//}
		checkNames();
		...
		//alert("You have " + itemTitle + " in the cart.");
		//var carItCtAf = googlecart.getItems();
		//alert(carItCtAf.length);
	});    	
