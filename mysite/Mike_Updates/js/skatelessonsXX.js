...
function checkNames(){
	...
	var curName;
	var fullName;
	if (fn=="" || fn==null || ln=="" || ln==null || selClassDayTime=="daytime" || selClassDayTime==null)
		{
			$('#erbox').css('visibility','visible');
...
/*function checkDayTimeSelected(val) {
	if (val=="" || val=="Choose Day & Time" || val=="daytime")
	{
		alert("Please select the day and time of the lesson");
		return false;
	}
...
$(document).ready(function() {
    ...
    $('#select_class').change(function(){
    	...
    	/*
    	else if ($('#select_class').val() == "Hockey 1")
    		{
    			var theThing = document.classes_form.select_day_time;
    			theThing.options[0]=new Option("Choose Day & Time", "daytime", true, true)
    			theThing.options[1]=new Option("Mon 7:00PM", "Monday 7:00PM", false, false)
    	...
    	*/
    	...
    	else if ($('#select_class').val() == "Axel Plus")
    		{
    			var theThing = document.classes_form.select_day_time;
    			theThing.options[0]=new Option("Choose Day & Time", "daytime", true, true)
    			theThing.options[1]=new Option("Sat 8:30AM", "Saturday 8:30AM", false, false)
	...
	*/
	...
	$('#googlecart-add').click(function(){
		...
		$('#product-attr-description').val($('#select_day_time option:selected').val());
		var prTitle = $('#product-title').val($('#select_class option:selected').val());
		var prDesc = $('#product-attr-description').val($('#select_day_time option:selected').val());
		
		
		var cartItems = googlecart.getItems()
		var itemTitle = googlecart.getItem(0).getTitle();
		if(cartItems.length > 0){
			alert("You have " + itemTitle + " items in the cart");
		}
		else
		{
